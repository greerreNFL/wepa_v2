...
for season in range(1999,last_season + 1):
    ...
    solution = minimize(wepa_objective, best_guesses_all_time, args=(pbp_df.copy(), season, 99), bounds=bounds, method='SLSQP')
...
wepa_df.to_csv('{0}wepa_game_flat_file.csv'.format(output_folder))
